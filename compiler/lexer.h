	...
	enum TokenType{
		...
		SEMICOLON, EQUALS_EQUALS, EQUALS, AND, OR, LEQ, NOT, GREATER, GEQ, LESS,
		MINUS, PLUS, TIMES, DIV, MOD, RET, FN, VAR, IF, WHILE,
		IDENTIFIER, NUMBER, UNKNOWN, END, COMMA, CHARACTER_TEMPORARY, STRING
	};
